...
public class Calon_Edit extends javax.swing.JFrame {
    ...
    public Calon_Edit(Object get_id_calon) {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Ubah Data Calon Nikah");
        ...
        txt_id_calon.setFont(new java.awt.Font("Arial", 1, 15)); // NOI18N
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(txt_id_calon, javax.swing.GroupLayout.PREFERRED_SIZE, 282, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(txt_id_calon, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        btn_tambah_calon_nikah.setText(" UBAH CALON NIKAH");
    ...
    private void btn_tambah_calon_nikahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_tambah_calon_nikahActionPerformed
        ...
        try {
            ...
            if (isEmpty()){
                ...
                sql = "UPDATE `data_calon_nikah` SET nik_csuami = '"+csuami_nik+"',"
                        + " nama_csuami = '"+csuami_nama+"', ttl_csuami = '"+csuami_ttl+"',"
                        + " alamat_csuami = '"+csuami_alamat+"', "
                        + "nik_cistri = '"+cistri_nik+"', nama_cistri = '"+cistri_nama+"', "
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Calon_Edit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Calon_Edit().setVisible(true);
            }
        });
    }
